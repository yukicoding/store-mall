...
INSERT INTO `comment` VALUES (6, 1, '1234', NULL);
INSERT INTO `comment` VALUES (7, 2, 'qwer', NULL);
...
CREATE TABLE `t_order`  (
  ...
  `o_price` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `o_isPaid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `o_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `o_createAt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `o_deliver` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `o_order` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `o_bookId` int(0) NULL DEFAULT NULL,
  `o_book` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (103, '98', 'Y', 'huangyongqi', '2022-06-05 19:01:02', '123123', '7UUwkqHwdwJXfUX8', 1, '《大盂鼎 金石名品》');
...
INSERT INTO `t_user` VALUES (63, 'huangyongqi', '$2a$10$IXPIv/7hnvsZFdVW3vd42e6rcVW.kaopf0WcEUaBA0RtI71vwWcKa', '1046410512@qq.com', NULL, 1, 7571);
